...
let game_manager = new GameManager(document.body, my_settings, broadcaster);
broadcaster.subscribe(game_manager);

let board = new Board(my_settings, broadcaster);
broadcaster.subscribe(board);

let board_render = new BoardRender(boardContainer, board, my_settings, broadcaster);
